//
//  RecordScriptUploadViewController.m
//  Appium
//
//  Created by xin liu on 15/2/9.
...
@implementation RecordScriptUploadViewController
...
- (IBAction)chooseScriptButtonClicked:(NSButton *)sender {
	...
	[chooseScriptPanlel setFrameOrigin:self.view.frame.origin];
	
	[chooseScriptPanlel setFrameTopLeftPoint:self.view.frame.origin];
	...
	[chooseScriptPanlel beginSheetModalForWindow:self.recordWindow.window completionHandler:^(NSInteger result) {
